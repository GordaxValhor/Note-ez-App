...
import NotesTeams from '../screens/Team Screens/NotesTeams';
import TasksTeams from '../screens/Team Screens/TasksTeams';
import AddTeams from '../screens/Team Screens/AddTeams';

const Tab = createBottomTabNavigator();
export const routeContex = React.createContext();


const tabStackTeams = ({route}) =>{
    ...
    return(
            ...
            >
                ...
                {/*  defapt notes este home */}
                    ...
                    <Tab.Screen name="Notes" component={NotesTeams} options={{
                        tabBarIcon:({focused}) =>(
                            <View>
                ...
                children={() => <AddTeams  addWhat={prevRoute}/>}
                />
                <Tab.Screen name="Tasks" component={TasksTeams} options={{
                    tabBarIcon:({focused}) =>(
                        <View>
